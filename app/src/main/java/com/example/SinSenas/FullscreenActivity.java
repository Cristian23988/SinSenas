...
public class FullscreenActivity extends AppCompatActivity {
    ...
    public void createDatosInicio() {
        ...
        double[][] sena_abc_b = new double[][]{{refDedos[0]*1.0,refDedos[0]*1.0, refDedos[1]*1.0, 0.20, 0.8},{refDedos[0]*1.0,refDedos[0]*1.0, refDedos[2]*1.0, 0.20, 0.8},{refDedos[0]*1.0,refDedos[0]*1.0, refDedos[3]*1.0, 0.20, 0.8},{refDedos[0]*1.0,refDedos[0]*1.0, refDedos[4]*1.0, 0.20, 0.8},{refDedos[0]*1.0,refDedos[0]*1.0, refBaseDedos[3]*1.0, 0.0, 0.18},{refDedos[1]*1.0,refMitadDedos[1]*1.0, refMitadDedos[2]*1.0, 0.0, 0.28},{refDedos[1]*1.0,refDedos[1]*1.0, refDedos[2]*1.0, 0.0, 0.28},{refDedos[2]*1.0,refMitadDedos[2]*1.0, refMitadDedos[3]*1.0, 0.0, 0.40},{refDedos[2]*1.0,refDedos[2]*1.0, refDedos[3]*1.0, 0.0, 0.40},{refDedos[3]*1.0,refMitadDedos[3]*1.0, refMitadDedos[4]*1.0, 0.0, 0.53},{refDedos[4]*1.0,(refMitadDedos[4]+1)*1.0, refDedos[4]*1.0, 0.0, 0.16}};
        double[][] sena_abc_c = new double[][]{{refDedos[0]*1.0,refDedos[0]*1.0, refDedos[1]*1.0, 0.1, 0.4},{refDedos[0]*1.0,refDedos[0]*1.0, refDedos[2]*1.0, 0.1, 0.4},{refDedos[0]*1.0,refDedos[0]*1.0, refDedos[3]*1.0, 0.1, 0.4},{refDedos[0]*1.0,refDedos[0]*1.0, refDedos[4]*1.0, 0.1, 0.4},{refDedos[1]*1.0,refMitadDedos[1]*1.0, refMitadDedos[2]*1.0, 0.0, 0.28},{refDedos[1]*1.0,refDedos[1]*1.0, refDedos[2]*1.0, 0.0, 0.28},{refDedos[2]*1.0,refMitadDedos[2]*1.0, refMitadDedos[3]*1.0, 0.0, 0.40},{refDedos[2]*1.0,refDedos[2]*1.0, refDedos[3]*1.0, 0.0, 0.40},{refDedos[3]*1.0,refMitadDedos[3]*1.0, refMitadDedos[4]*1.0, 0.0, 0.53},{refDedos[4]*1.0,(refMitadDedos[4]+1)*1.0, refDedos[4]*1.0, 0.0, 0.16}};
        double[][] sena_abc_d = new double[][]{{refDedos[0]*1.0,refDedos[0]*1.0, refDedos[1]*1.0, 0.2, 0.8},{refDedos[0]*1.0,refDedos[0]*1.0, refDedos[2]*1.0, 0.0, 0.18},{refDedos[0]*1.0,refDedos[0]*1.0, refDedos[3]*1.0, 0.0, 0.18},{refDedos[0]*1.0,refDedos[0]*1.0, refDedos[4]*1.0, 0.0, 0.18},{refDedos[1]*1.0,refMitadDedos[1]*1.0, refMitadDedos[2]*1.0, 0.0, 0.28},{refDedos[1]*1.0,refDedos[1]*1.0, refDedos[2]*1.0, 0.1, 0.45},{refDedos[2]*1.0,refMitadDedos[2]*1.0, refMitadDedos[3]*1.0, 0.0, 0.40},{refDedos[2]*1.0,refDedos[2]*1.0, refDedos[3]*1.0, 0.0, 0.40},{refDedos[3]*1.0,refMitadDedos[3]*1.0, refMitadDedos[4]*1.0, 0.0, 0.53},{refDedos[4]*1.0,(refMitadDedos[4]+1)*1.0, refDedos[4]*1.0, 0.0, 0.16}};
        double[][] sena_abc_e = new double[][]{{refDedos[0]*1.0,refMitadDedos[0]*1.0, refDedos[1]*1.0, 0.0, 0.1},{refDedos[0]*1.0,refDedos[0]*1.0, refDedos[1]*1.0, 0.0, 0.18},{refDedos[0]*1.0,refDedos[0]*1.0, refDedos[2]*1.0, 0.0, 0.1},{refDedos[0]*1.0,refDedos[0]*1.0, refDedos[3]*1.0, 0.0, 0.18},{refDedos[0]*1.0,refDedos[0]*1.0, refDedos[4]*1.0, 0.0, 0.18},{refDedos[1]*1.0,refMitadDedos[1]*1.0, refMitadDedos[2]*1.0, 0.0, 0.28},{refDedos[1]*1.0,refDedos[1]*1.0, refDedos[2]*1.0, 0.1, 0.45},{refDedos[2]*1.0,refMitadDedos[2]*1.0, refMitadDedos[3]*1.0, 0.0, 0.40},{refDedos[2]*1.0,refDedos[2]*1.0, refDedos[3]*1.0, 0.0, 0.40},{refDedos[3]*1.0,refMitadDedos[3]*1.0, refMitadDedos[4]*1.0, 0.0, 0.53},{refDedos[4]*1.0,(refMitadDedos[4]+1)*1.0, refDedos[4]*1.0, 0.0, 0.16}};
        double[][][] arrSenas = new double[][][]{sena_abc_a,sena_abc_b, sena_abc_c, sena_abc_d, sena_abc_e};
        String[] senas = new String[]{"A","B","C","D","E"};
